...
public class VEPTeleporter extends Teleporter {
	...
	public boolean makePortal(Entity entity) {
		...
		IBlockState iblockstate = Blocks.PORTAL.getDefaultState().withProperty(
				BlockPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X
		).withProperty(
				BlockNetherPortal.MANUALLY_PLACED, false
		);

		VerticalEndPortals.LOGGER.error(iblockstate);
